...
#define numsensors 4 //define number of sensors you are using


float P = 0 , I = 0 , D = 0, error = 0, LP = 0;

float kp = 0.001;  //Modify these values depending on your robot
float ki = 5;      //Modify these values depending on your robot
float kd = 0;      //Modify these values depending on your robot
int r_spd, l_spd, max_spd = 200;  //Set max_spd depending on your speed of motors
...
void pid_calc()
{ pos = int(Saverage / Ssum);
  P = pos - 1383; //Find the postion and replace the value
  I = I + P;
  D = P - LP;
  LP = P;
